...
impl EntryContainer {
    ...
    pub fn update_filter(&mut self, current_index: Option<usize>, pred: Option<Box<FnMut(&mut Entry) -> bool>>) -> Option<usize> {
        self.entries.update_filter(current_index, pred)
    }
}
